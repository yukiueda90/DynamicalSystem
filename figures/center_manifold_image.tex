...
\begin{document}
    \begin{tikzpicture}[baseline]
        \begin{axis}[
            ...
            % \addplot[tab_blue, domain=-0.25:1.5, samples=100, very thick] ({x}, {-sqrt((1+sqrt(1+4*x))/2)});   
            % \addplot[tab_blue, domain=-0.25:0, samples=100, very thick, dashed] ({x}, {-sqrt((1-sqrt(1+4*x))/2)});   
            \addplot[tab_blue, domain=-0.7:1.5, samples=3, very thick, dashed] ({x}, {x/2});   
            \addplot[tab_blue, domain=-0.3:0.7, samples=3, very thick, dashed] ({x}, {2*x}); 
            \addplot[tab_blue, domain=-0.4:0.6, samples=100, very thick] ({2*x + x^3}, {x + 2*x^3});
            \node at (0.0, 0.0) {$\bullet$};
            \node at (0.1, -0.1) {$\widetilde{\mathbf{x}}$};
            \node at (1.4, 0.5) {$E^c$}; 
            \node at (0.4, 1.2) {$E^s$}; 
