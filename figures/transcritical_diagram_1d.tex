...
\begin{document}
    \begin{tikzpicture}[baseline]
        \begin{axis}[
            scale=0.8, % scale
            xmin=-0.9,xmax=0.9,ymin=-0.9,ymax=0.9, % range of plot
            ...
            \addplot[tab_blue, domain=-0.7:0.0, samples=100, very thick, dashed] {x};
            \addplot[tab_blue, domain=-0.7:0.0, samples=100, very thick] (x, {0});   
            \addplot[tab_blue, domain=0.0:0.7, samples=100, very thick] {x};   
            \addplot[tab_blue, domain=0.0:0.7, samples=100, very thick, dashed] {0};
            % \node at (2.2, 3.2) {$r=0$};
            % \node at (2.2, 3.7) {$r>0$};
            % \node at (2.2, 2.7) {$r<0$};
